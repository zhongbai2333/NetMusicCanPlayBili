 ...
 * </p>
 */
final class IrisShaderpackCompat {
    ...
    private static volatile boolean yuvPipelineAssigned;
    private static volatile boolean texturedProbePipelineAssigned;
    ...
    static boolean isShaderPackInUse() {
        ...
        try {
            ...
            if (inUse != lastShaderPackInUse) {
                ...
                yuvPipelineAssigned = false;
                texturedProbePipelineAssigned = false;
    ...
    private static void assignPipelineIfRequested(RenderPipeline pipeline, String programName, boolean texturedProbe) {
        ...
        if (texturedProbe ? texturedProbePipelineAssigned : yuvPipelineAssigned) {
            return;
        }
        synchronized (IrisShaderpackCompat.class) {
            ...
            try {
                ...
                if (texturedProbe) {
                    texturedProbePipelineAssigned = true;
                } else {

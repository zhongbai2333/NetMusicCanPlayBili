...
/**
 * 保证本模组的视频相关 fragment shader 留在自己的 pipeline 上，而不是让 Iris shaderpack
 * 替换编译后的程序。所有检查都限定在本模组 pipeline id；这里不会修改 Iris 全局状态。
 */
public final class IrisYuvShaderOverrideGuard {
    ...
    private static boolean isBypassPipelineId(RenderPipeline pipeline) {
        return isYuvPipelineId(pipeline);
    }

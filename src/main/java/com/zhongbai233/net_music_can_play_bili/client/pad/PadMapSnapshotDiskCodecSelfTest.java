...
/** Lightweight self tests for snapshot disk cache binary codec. */
public final class PadMapSnapshotDiskCodecSelfTest {
    private PadMapSnapshotDiskCodecSelfTest() {
    }

    public static void main(String[] args) throws Exception {
        roundTripsSnapshotFile();
        rejectsUnexpectedShape();
        rejectsInvalidHeader();
        System.out.println("PadMapSnapshotDiskCodecSelfTest passed");
    }

    private static void roundTripsSnapshotFile() throws Exception {
        Path path = Files.createTempFile("pad-map-snapshot", ".bin");
        try {
    ...
    private static void rejectsUnexpectedShape() throws Exception {
        Path path = Files.createTempFile("pad-map-snapshot-shape", ".bin");
        try {
    ...
    private static void rejectsInvalidHeader() throws Exception {
        Path path = Files.createTempFile("pad-map-snapshot-header", ".bin");
        try {

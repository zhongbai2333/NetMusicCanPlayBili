...
/** 轻量离线自测：不启动 Minecraft，只验证 Pad 地图样式后处理。 */
public final class PadMapStyleSelfTest {
    private PadMapStyleSelfTest() {
    }

    public static void main(String[] args) {
        fillsSingleCellHoleInBuilding();
        fillsOutdoorSingleCellHoleWithoutBridging();
        fillsEnclosedOutdoorCourtyard();
        doesNotFillLargeCourtyardPlaza();
        keepsOpenCourtyardOpen();
        ignoresSingleBuildingNoise();
        keepsSeparatedBuildingsSeparated();
        System.out.println("PadMapStyleSelfTest passed");
    }

    private static void fillsSingleCellHoleInBuilding() {
    ...
    private static void fillsOutdoorSingleCellHoleWithoutBridging() {
    ...
    private static void fillsEnclosedOutdoorCourtyard() {
    ...
    private static void doesNotFillLargeCourtyardPlaza() {
    ...
    private static void keepsOpenCourtyardOpen() {
        PadMapSnapshot snapshot = snapshot(11, 9, new String[] {
                "...........",
                ".BBBBBBBBB.",
                ".BBBBBBBBB.",
    ...
    private static void ignoresSingleBuildingNoise() {
    ...
    private static void keepsSeparatedBuildingsSeparated() {
        PadMapSnapshot snapshot = snapshot(7, 5, new String[] {
                ".......",
                ".BB.BB.",
                ".BB.BB.",
